...
{
  public class CShortStrangle : CCombination, ICombination
  {
    /// <summary>
    ...
    public IScore GetScore(IEnumerable<IGroup> groups)
    {
      ...
      optionUp.Direction = EDirection.Short;
      optionDown.Direction = EDirection.Short;

      return new CScore
      {
        Debit = CType.ToMoneyStr(0),
        Credit = CType.ToMoneyStr(optionUp.Bid + optionDown.Bid),
        Symbol = quote.Symbol,
