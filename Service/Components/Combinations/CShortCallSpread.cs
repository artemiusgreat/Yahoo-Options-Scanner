...
{
  public class CShortCallSpread : CCombination, ICombination
  {
    /// <summary>
    ...
    public IScore GetScore(IEnumerable<IGroup> groups)
    {
      ...
      return new CScore
      {
        ...
        Credit = CType.ToMoneyStr(optionLong.Ask - optionShort.Bid),
        Symbol = quote.Symbol,
        Distance = CType.ToMoneyStr(optionShort.Strike - quote.Ask),
